...
@Configuration
@ComponentScan(basePackages ={"com.iservu"})
...
public class ApplicationContextConfig {
	...
	private final static String JDBC_USERNAME = "COLL";
	private final static String JDBC_PASSWORD = "Coll";
	...
	public SessionFactory sessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("com.iservu");
	...
	private Properties hibernateProperties() {
		...
		properties.setProperty("hibernate.default_schema", "COLL");
		return properties;
	}
